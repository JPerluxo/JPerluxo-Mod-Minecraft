...
## [1.0.5] - 2025-09-17
### Added
- Introduced the **JPerluxo's Armor** set (helmet, chestplate, leggings, boots), crafted using the JPerluxo's Shards.
- Added an advancement that unlocks recipes upon obtaining a JPerluxo's Shard.
