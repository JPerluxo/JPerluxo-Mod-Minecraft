...
## [1.0.5] - 2025-10-28
### Added
- Introduced the **Blaze Sword** — an epic fire sword with custom flame effects.

### Fixed
- Reorganized the mod into independent modules. This improves code structure and modularity, allowing easier feature management.
